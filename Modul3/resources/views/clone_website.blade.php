        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">                    
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/main.svg') }}" alt="logo">
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/bs-themes.png') }}" alt="Bootsrap-themes" >
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-thumbnail" src="{{ Vite::asset('resources/images/logo-black.svg') }}" alt="logo" style="width: 40px;">
